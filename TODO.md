...
- [CSE481C course](https://github.com/cse481wi18/cse481wi18/wiki)
- [MoveIt! tutorials](https://ros-planning.github.io/moveit_tutorials/)
- [Pick and place tutorial](http://docs.ros.org/kinetic/api/moveit_tutorials/html/doc/pick_place/pick_place_tutorial.html)

## Object detection

- [YOLO ROS: Real-Time Object Detection for ROS](https://github.com/leggedrobotics/darknet_ros)
- [TensorFlow Image Recognition](https://www.youtube.com/watch?v=AlGnUl1QFac)
- [Using Tensorflow & ROS](https://www.youtube.com/watch?v=GWc_hmegMw4)
- [Object Recognition and flat surfaces](https://www.youtube.com/watch?v=jwwV8fuQ-TE)
- [`rail_segmentation` package](http://wiki.ros.org/rail_segmentation)
- [`find_object_2d` package](http://wiki.ros.org/find_object_2d)
- [`object_recogn_tc` package](https://bitbucket.org/theconstructcore/tc_object_recogn/src/master/object_recogn_tc/)
- [Table segmentation with PCL ROS](https://www.youtube.com/watch?v=EORZFBCXdvw)
- [Region segmentation with TIAGo robot](http://wiki.ros.org/Robots/TIAGo/Tutorials/RegionSegmentation)
